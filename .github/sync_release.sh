...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-CityConnection_MiSTer.git"
CORE_NAME=(CityConnection)
...
UPSTREAM_CORE_NAME=(CityConnection)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(CityConnection.qpf)
COMPILATION_OUTPUT=(output_files/CityConnection.rbf)
